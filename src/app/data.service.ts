...
export class DataService {
    ...
    cargarPersonas(){
        return this.httpClient.get('https://listar-personas.firebaseio.com/datos.json');
    }

    //Guarda todo el arreglo de personas
    guardarPersonas(personas: Persona[]) {
        this.httpClient.put('https://listar-personas.firebaseio.com/datos.json', personas)
            .subscribe(
                (response) => {
    ...
    modificarPersona(index:number, persona: Persona){
        let url: string;
        url = 'https://listar-personas.firebaseio.com/' + '/datos/' + index + '.json';
